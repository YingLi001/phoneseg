...
def main():
    ...
    print("learning_rate=1e-5, bs=8, e=50")
    print("test 2")
    # load Torgo_TD dataset
    ...
    if True:
        ## TOKENIZER CLASS
        tokenizer = Wav2Vec2CTCTokenizer(vocab_file = "/mnt/data/ying/checkpoints/Torgo/saves_1b/vocab.json",
        ...
        ## SAVE PROCESSOR
        processor.save_pretrained("/mnt/data/ying/checkpoints/Torgo/saves_1b")
    elif os.path.isdir('./saves_1b'):
        processor = Wav2Vec2Processor.from_pretrained("/mnt/data/ying/checkpoints/Torgo/saves_1b")
    ...
    timit_prepared = timit.map(prepare_dataset, remove_columns=timit.column_names["train"], num_proc=8,
                               batched=True)
    ...
    training_args = TrainingArguments(
        output_dir="/mnt/data/ying/checkpoints/Torgo/wav2vec2_1b_TORGO/8bs50e_1b_1e-5",
    ...
    processor = Wav2Vec2Processor.from_pretrained("/mnt/data/ying/checkpoints/Torgo/saves_1b")
    model = Wav2Vec2ForCTC.from_pretrained("/mnt/data/ying/checkpoints/Torgo/wav2vec2_1b_TORGO/8bs50e_1b_1e-5/checkpoint-21750")
    ...
    # pred_single_wav('/mnt/data/ying/checkpoints/Thesispackage_Torgo/wav2vec2-large-xlsr-53-torgoTD-checkpoints/4bs10e-PHN-SN-divided-same-as-SSD-group/checkpoint-4750', '/mnt/data/ying/TORGO_Control_Group_Amend_PHN_SN_divided_same_as_SSD_group/data/TEST/MC04/Session1/0005.wav')
    pred_single_wav('/mnt/data/ying/checkpoints/Torgo/wav2vec2_1b_TORGO/8bs50e_1b_1e-5/checkpoint-21750', '/mnt/data/ying/TORGO_Control_Group_Amend_PHN_SN_divided_same_as_SSD_group/data/TEST/MC04/Session1/0005.wav')
